...
<head>
  ...
  <title>Helping Hands - @yield('title')</title>
...
<section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>Helping<span>Hands</span></b></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="grids.html">N.I.C</a></li>
              <li><a href="calendar.html">Birth Certificate</a></li>
              <li><a href="gallery.html">Death Certificate</a></li>
              <li><a href="todo_list.html">GS Letter</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Appslanka</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
